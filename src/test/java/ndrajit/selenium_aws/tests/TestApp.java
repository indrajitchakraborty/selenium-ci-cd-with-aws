...
import ndrajit.selenium_aws.baseconfig.BaseClass;
...
public class TestApp extends BaseClass {
    ...
    public void clickProduct(){
        ...
        DriverFactory.getDriver().findElement(By.xpath("(//div[@class='shop-menu pull-right']//li)[2]")).click();
        System.out.println("Click on Product successfully..");
    }

    @Test(groups = "regression")
    public void clickHome(){
        DriverFactory.getDriver().findElement(By.xpath("(//div[@class='shop-menu pull-right']//li)[1]")).click();
